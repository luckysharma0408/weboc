...
<li><a href="#four" class="page-scroll"><h3>Inspire</h3></a></li>
                                 
<li><a href="#seven" class="page-scroll"><h3>Featues</h3></a></li>
...
<h1 class="main-heading-title">Plan your Journey</h1>
...
<a href="#four" class="btn btn-custom-outline">Contact Us</a>
...
<section class="Features white-background black" id="seven">
...
<h3 class="title"><span class="themecolor" style="margin-top:20px">What makes us best</span></h3>
...
<div class="col-md-4"> <small>&copy; 2019, Brought To You By <a href="https://code-projects.org/">BookRail</a> </small></div>
